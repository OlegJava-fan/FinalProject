...
public class SortByPayPlaceFacultiesCommand extends Command {
    private static final long serialVersionUID = 2908969685742353424L;
    private static final Logger LOGGER = Logger.getLogger(SortByPayPlaceFacultiesCommand.class);
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            Comparator<Faculties> comparator = Comparator.comparing(Faculties::getPayFormPlaces);
