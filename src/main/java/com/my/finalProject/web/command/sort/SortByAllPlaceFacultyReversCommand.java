...
public class SortByAllPlaceFacultyReversCommand extends Command {
    private static final long serialVersionUID = 2919624252721069722L;
    private static final Logger LOGGER = Logger.getLogger(SortByAllPlaceFacultyCommand.class);
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            Comparator<Faculties> comparator = Comparator.comparing(Faculties::getAllPlace).reversed();
            ...
            LOGGER.error("your session expire");
