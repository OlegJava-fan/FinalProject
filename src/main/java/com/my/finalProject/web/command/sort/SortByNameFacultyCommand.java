...
public class SortByNameFacultyCommand extends Command {
    private static final long serialVersionUID = 2362456234754893435L;
    private static final Logger LOGGER = Logger.getLogger(SortByNameFacultyCommand.class);
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            Comparator<Faculties> comparator = Comparator.comparing(Faculties::getName);
