...
public class SortByNameFacultyReversCommand extends Command {
    private static final long serialVersionUID = 64544253234735326L;
    private static final Logger LOGGER = Logger.getLogger(SortByNameFacultyReversCommand.class);
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            Comparator<Faculties> comparator = Comparator.comparing(Faculties::getName).reversed();
