...
public class SortByAllPlaceFacultyCommand extends Command {
    private static final long serialVersionUID = 29089623467564534L;
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            Comparator<Faculties> comparator = Comparator.comparing(Faculties::getAllPlace);
        ...
        LOGGER.debug("you dont have a role");
